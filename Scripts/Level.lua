...
function Level:createFloorTile(mesh,x,y,textureID)
    ...
    newPoly:addVertex((x*self.scale),0,(y*self.scale)+self.scale,offsetX+stepX,0)
    newPoly:addVertex((x*self.scale)+self.scale,0,(y*self.scale)+self.scale,offsetX+stepX,1)
    newPoly:addVertex((x*self.scale)+self.scale,0,(y*self.scale),offsetX,1)
    mesh:addPolygon(newPoly)
 

    newPoly = Polygon()
    newPoly:addVertex((x*self.scale),0,(y*self.scale)+self.scale,offsetX+stepX, 1)
    newPoly:addVertex((x*self.scale)+self.scale,0,(y*self.scale),offsetX, 1)
    newPoly:addVertex((x*self.scale),0,(y*self.scale),offsetX, 0)    
    mesh:addPolygon(newPoly)
end
...
function Level:createHoleTile(mesh,x,y)
    ...
    newPoly = Polygon()
    newPoly:addVertex((x*self.scale),self.sheight,(y*self.scale),offsetX,0)
    newPoly:addVertex((x*self.scale)+self.scale,self.sheight,(y*self.scale),offsetX, 1)
    newPoly:addVertex((x*self.scale)+self.scale,0,(y*self.scale),offsetX+stepX, 0)
    mesh:addPolygon(newPoly)
 
    newPoly = Polygon()
    newPoly:addVertex((x*self.scale),self.sheight,(y*self.scale),offsetX, 1)
    newPoly:addVertex((x*self.scale)+self.scale,0,(y*self.scale),offsetX+stepX,1)
    newPoly:addVertex((x*self.scale),0,(y*self.scale),offsetX+stepX,0)
    mesh:addPolygon(newPoly)   
    end

    if self.worldData[x][y+1] ~= 9 then
    newPoly = Polygon()
    newPoly:addVertex((x*self.scale)+self.scale,0,(y*self.scale)+self.scale,offsetX, 1)      
    newPoly:addVertex((x*self.scale)+self.scale,self.sheight,(y*self.scale)+self.scale,offsetX+stepX, 1)
	newPoly:addVertex((x*self.scale),self.sheight,(y*self.scale)+self.scale,offsetX+stepX, 0)
    mesh:addPolygon(newPoly) 
      
    newPoly = Polygon()
    newPoly:addVertex((x*self.scale),self.sheight,(y*self.scale)+self.scale,offsetX+stepX, 0)
    newPoly:addVertex((x*self.scale)+self.scale,0,(y*self.scale)+self.scale,offsetX,1)      
    newPoly:addVertex((x*self.scale),0,(y*self.scale)+self.scale,offsetX, 0)
    mesh:addPolygon(newPoly)            
    end
      
    if self.worldData[x-1][y] ~= 9 then
    newPoly = Polygon()
    newPoly:addVertex((x*self.scale),0,(y*self.scale)+self.scale,offsetX, 1)      
    newPoly:addVertex((x*self.scale),self.sheight,(y*self.scale)+self.scale,offsetX+stepX, 1)
    newPoly:addVertex((x*self.scale),self.sheight,(y*self.scale),offsetX+stepX, 0)
    mesh:addPolygon(newPoly)
    ...
    if self.worldData[x+1][y] ~= 9 then
    newPoly = Polygon()
    newPoly:addVertex((x*self.scale)+self.scale,self.sheight,(y*self.scale),offsetX+stepX,0)      
    newPoly:addVertex((x*self.scale)+self.scale,self.sheight,(y*self.scale)+self.scale,offsetX+stepX,1)
    newPoly:addVertex((x*self.scale)+self.scale,0,(y*self.scale)+self.scale,offsetX,1)  
    mesh:addPolygon(newPoly)
    ...
    newPoly:addVertex((x*self.scale)+self.scale,self.sheight,(y*self.scale),offsetX+stepX,0)      
    newPoly:addVertex((x*self.scale)+self.scale,0,(y*self.scale)+self.scale,offsetX,1) 
    newPoly:addVertex((x*self.scale)+self.scale,0,(y*self.scale),offsetX,0)          
    mesh:addPolygon(newPoly)   
    end
...
function Level:createWallTile(mesh,x,y,textureID)
    ...
    local newPoly = Polygon()
    newPoly:addVertex((x*self.scale),self.sheight,(y*self.scale)+self.scale,0,offsetX+stepX)   
    newPoly:addVertex((x*self.scale)+self.scale,self.sheight,(y*self.scale)+self.scale,1,offsetX+stepX)
    newPoly:addVertex((x*self.scale)+self.scale,self.sheight,(y*self.scale),1,offsetX)
    mesh:addPolygon(newPoly)
 
    newPoly = Polygon()
    newPoly:addVertex((x*self.scale),self.sheight,(y*self.scale)+self.scale,0,offsetX+stepX)
    newPoly:addVertex((x*self.scale)+self.scale,self.sheight,(y*self.scale),1,offsetX)
    newPoly:addVertex((x*self.scale),self.sheight,(y*self.scale),0,offsetX)    
    mesh:addPolygon(newPoly)    
    ...
    newPoly:addVertex((x*self.scale),self.sheight,(y*self.scale),0,offsetX)
    newPoly:addVertex((x*self.scale)+self.scale,self.sheight,(y*self.scale),1,offsetX)
    newPoly:addVertex((x*self.scale)+self.scale,0,(y*self.scale),0,offsetX+stepX)
    mesh:addPolygon(newPoly)
 
    newPoly = Polygon()
    newPoly:addVertex((x*self.scale),self.sheight,(y*self.scale),1,offsetX)
    newPoly:addVertex((x*self.scale)+self.scale,0,(y*self.scale),1,offsetX+stepX)
    newPoly:addVertex((x*self.scale),0,(y*self.scale),0,offsetX+stepX)
    mesh:addPolygon(newPoly)    

    newPoly = Polygon()
    newPoly:addVertex((x*self.scale)+self.scale,0,(y*self.scale)+self.scale,1,offsetX)      
    newPoly:addVertex((x*self.scale)+self.scale,self.sheight,(y*self.scale)+self.scale,1,offsetX+stepX)            newPoly:addVertex((x*self.scale),self.sheight,(y*self.scale)+self.scale,0,offsetX+stepX)
    mesh:addPolygon(newPoly) 
      
    newPoly = Polygon()
    newPoly:addVertex((x*self.scale),0,(y*self.scale)+self.scale,0,offsetX)          
    newPoly:addVertex((x*self.scale)+self.scale,0,(y*self.scale)+self.scale,1,offsetX)      
    newPoly:addVertex((x*self.scale),self.sheight,(y*self.scale)+self.scale,0,offsetX+stepX)
    mesh:addPolygon(newPoly)            
      
    newPoly = Polygon()
    newPoly:addVertex((x*self.scale),0,(y*self.scale)+self.scale,1,offsetX)      
    newPoly:addVertex((x*self.scale),self.sheight,(y*self.scale)+self.scale,1,offsetX+stepX)
    newPoly:addVertex((x*self.scale),self.sheight,(y*self.scale),0,offsetX+stepX)
    mesh:addPolygon(newPoly)
 
    newPoly = Polygon()
    newPoly:addVertex((x*self.scale),0,(y*self.scale),0,offsetX)          
    newPoly:addVertex((x*self.scale),0,(y*self.scale)+self.scale,1,offsetX)      
    newPoly:addVertex((x*self.scale),self.sheight,(y*self.scale),0,offsetX+stepX)
    mesh:addPolygon(newPoly)    
      
    newPoly = Polygon()
    newPoly:addVertex((x*self.scale)+self.scale,self.sheight,(y*self.scale),0,offsetX+stepX)      
    newPoly:addVertex((x*self.scale)+self.scale,self.sheight,(y*self.scale)+self.scale,1,offsetX+stepX)
    newPoly:addVertex((x*self.scale)+self.scale,0,(y*self.scale)+self.scale,1,offsetX)  
    mesh:addPolygon(newPoly)
    ...
    newPoly:addVertex((x*self.scale)+self.scale,self.sheight,(y*self.scale),0,offsetX+stepX)      
    newPoly:addVertex((x*self.scale)+self.scale,0,(y*self.scale)+self.scale,1,offsetX) 
    newPoly:addVertex((x*self.scale)+self.scale,0,(y*self.scale),0,offsetX)          
    mesh:addPolygon(newPoly)        
end
...
function Level:checkArrowAttack(arrow, defending)
       ...
       if levelRotate == true then
        ...
        local attackingFrom = arrow.body.z+0.01
        local attackingTo = arrow.body.z - 0.12

        if arrow.dirMod == -1 then     
            attackingFrom = arrow.body.z + 0.12
            attackingTo = arrow.body.z - 0.01
        end


        if defending:checkHitZ(attackingFrom,attackingTo,arrow.body.x - 0.05,arrow.body.x + 0.05) == true and arrow.body.y < 0.12 then
           ...
           if defending:getHit() == true then
               self:bleed(defending.x, defending.z, defending.blood)
            end
        ...
        if arrow.dirMod == -1 then     
            attackingFrom = arrow.body.x - 0.12
            attackingTo = arrow.body.x    
        end

        if defending:checkHitX(attackingFrom,attackingTo, arrow.body.z - 0.09,arrow.body.z + 0.12) == true and arrow.body.y < 0.12 then
            if defending ~= player and defending.hasShield then
                if math.random(10) < 3 then defending:Block() end
            end
           if defending:getHit() == true then
...
function Level:checkSpellAttack(spell, defending)
       ...
       if levelRotate == true then
        ...
        local attackingFrom = spell.body.z+0.01
        local attackingTo = spell.body.z - 0.14
...
function Level:checkAttack(attacking, defending)
       ...
       if levelRotate == true then
            ...
            attackingFrom = attacking.z+0.03
            attackingTo = attacking.z - 0.15

        if attacking.movDirMod == -1 then     
            attackingFrom = attacking.z + 0.15
            attackingTo = attacking.z - 0.03
        end

        if defending:checkHitZ(attackingFrom,attackingTo,attacking.x - 0.03,attacking.x + 0.03) == true then
           if defending:getHit() == true then
               self:bleed(defending.x, defending.z,defending.blood)
           end
...
function Level:doBleed(x,y,bloodType)
    ...
    blood.x = x - 0.06 + (random() * 0.12)
    blood.z = y - 0.06 + (random() * 0.12)
...
function Level:makeArrow()
    local arrow = {}
    arrow.body = ScenePrimitive(ScenePrimitive.TYPE_PLANE, 0.07,0.035,0)
...
function Level:initBlood()
    self.curBlood = 0
    for i=0,40 do
        local blood = ScenePrimitive(ScenePrimitive.TYPE_VPLANE, 0.1,0.1,0)
        blood.pitch = -90
...
function Level:updateArrows(e)
    ...
    for i=0,self.numSpells-1 do
        ...
        if fireball.levelRotate == true then
            fireball.z = fireball.z - (2.5*e*fireball.dirMod)
        else
            fireball.x = fireball.x + (2.5*e*fireball.dirMod)
        end
        
        if fireball.y > 0.05 then
           fireball.y = fireball.y - (e*3)
        else
           fireball.y = 0.05
        end

        fireball.body:setPosition(fireball.x,fireball.y+self.spellPerlin:Get(self.spellPerlinPos, 0.5)*0.0,fireball.z+self.spellPerlin:Get(self.spellPerlinPos, 1)*0.15)

        if self:canPass(fireball.x, fireball.z) == false then
            fireball.x = 1000
			fireball.z = 1000
        end
...
function Level:createIceball()
    ...
    fireball.flame = ScenePrimitive(ScenePrimitive.TYPE_PLANE, 0.02,0.02,0)
...
function Level:castFireball(creature)
    self.castFireballSound:Play(true)
    local fireball = self.fireballs[self.curFireball]
    fireball.x = creature:getPosition().x+0.03
    fireball.y = creature:getPosition().y+0.07
    fireball.z = creature:getPosition().z-0.01
    fireball.shooter = creature
    fireball.levelRotate = levelRotate
    fireball.dirMod = creature.movDirMod
    fireball.type = 0
...
function Level:getPathFindTarget(source, dest)
    ...
    if pathSize > 0 then
        ...
        retPoint.x = source:getPosition().x
        retPoint.z = source:getPosition().z
    end
...
function Level:tileToPosition(x,y)
    ...
    if x == nil then ret.x = 0 else
        ret.x = (-23*self.scale) + (x * self.scale)
    end
    if y == nil then ret.y = 0 else
        ret.y = (-24*self.scale) + (y * self.scale)
    end
...
function Level:positionToTile(x,y)
    ...
    ret.x = math.floor(((x + (23*self.scale)) / self.scale)) + 1 
    ret.y = math.floor(((y + (23*self.scale)) / self.scale)) + 1
...
function Level:createProp(propType,x,y)
    ...
    prop.x = (-23*self.scale) + (x * self.scale)
    prop.z = (-24*self.scale) + (y * self.scale) - 0.04
        ...
        if math.random() > 0.5 then
            for i=0,math.random(2) do
                ...
                if creature ~= nil then
                    creature.x = (-24*self.scale) + ((rect.x + math.ceil(math.random() * rect.w)) * self.scale)
                    creature.z = (-24*self.scale) + ((rect.y + math.ceil(math.random()*rect.h)) * self.scale)
                end
            end
        end
    end
...
function Level:createFire()
        ...
        self.particleEmitter.__cbody.particleSpeedMod = 0.4
...
function Level:addTorch(x,y)
    ...
    self:addLight(light)
    light:Translate(((-24*self.scale) + (x * self.scale)) - 0.1,0.05,(-24*self.scale) + (y * self.scale))
...
function Level:createEntranceExit()
    ...
    while ok == false do
        ...
        endVector.__cbody.x =  self.levelEndX
        endVector.__cbody.z =  self.levelEndY

        if self.worldData[self.levelEndX][self.levelEndY] == 0 and startVector.__cbody:distance(endVector.__cbody) > 3.5  then ok = true end
    end
    ...
    self.exitGlow = ScenePrimitive(ScenePrimitive.TYPE_PLANE, 0.10,0.16,0)
    ...
    local pos = self:tileToPosition(self.levelEndX, self.levelEndY)
       ...
       self.exitGlow.x = pos.x + 0.05
       self.exitGlow.z = pos.y - 0.08
       self.exitGlow.y = 0.08
...
function Level:Update(e)
    ...
    if levelRotate == true then
       self.exitGlow:getPosition().x = self.exitGlowX - 0.025
    else
       self.exitGlow:getPosition().x = self.exitGlowX + 0.05
    end
...
--[[
    local wall = ScenePrimitive(ScenePrimitive.TYPE_VPLANE, 50*self.scale,50*self.scale,0)
    self:addChild(wall)
    wall:setMaterialByName(self.levelSkin.."Wall")
    wall:Translate(0,0,(-24*self.scale)-(self.scale*0.5))

    wall = ScenePrimitive(ScenePrimitive.TYPE_VPLANE, 50*self.scale,50*self.scale,0)
    self:addChild(wall)
    wall.yaw = 180
    wall:setMaterialByName(self.levelSkin.."Wall")
    wall:Translate(0,0,24*self.scale)
    ...
    self:addChild(wall)
    wall:setMaterialByName(self.levelSkin.."Wall")
    wall:Translate((-24*self.scale)+(self.scale*0.3),0,0)

    wall = ScenePrimitive(ScenePrimitive.TYPE_VPLANE, 50*self.scale,50*self.scale,0)
    wall.yaw = -90
    self:addChild(wall)
    wall:setMaterialByName(self.levelSkin.."Wall")
    wall:Translate(25*self.scale,0,0)
--]]
    ...
    worldMesh:calculateNormals()  
    world = SceneMesh.SceneMeshFromMesh(worldMesh)
    world:setMaterialByName(self.levelSkin)

    world:Translate(-24*self.scale,0,-24*self.scale)
    world:Translate(self.scale*0.5,0,-0.5*self.scale)
    self:addChild(world)
