...
creatureLibrary = {
    orcraider = {name="Orc Raider", imageIndex=12, HP=2, speed=0.5, aitype=AI_MELEE, hasShield=false},
    orcenforcer = {name="Orc Enforcer", imageIndex=13, HP=4, speed=0.4, aitype=AI_MELEE, hasShield=true},
    orcarchereasy = {name="Orc Archer Apprentice", imageIndex=14, HP=1, speed=0.3, aitype=AI_ARCHER, hasShield=false},
    orcarchermed = {name="Orc Archer", imageIndex=15, HP=2, speed=0.4, aitype=AI_ARCHER, hasShield=false},
    greenslime = {name="Green Slime", blood="YellowBlood", imageIndex=16, HP=1, speed=0.3, aitype=AI_MELEE, hasShield=false},
    blueslime = {name="Blue Slime", blood="YellowBlood", imageIndex=17, HP=2, speed=0.4, aitype=AI_MELEE, hasShield=false},
    fireslime = {name="Fire Slime", blood="BlackBlood", imageIndex=21, HP=3, speed=0.5, aitype=AI_MELEE, hasShield=false},
    firehorror = {name="Fire Horror", blood="BlackBlood", imageIndex=22, HP=10, speed=0.1, aitype=AI_MELEE, hasShield=false},
    darkeye = {name="Fire Eye", blood="BlackBlood", imageIndex=20, HP=4, speed=0.4, aitype=AI_MAGE, spellID=0, hasShield=false},
    skelsoldier = {name="Skeleton Soldier", blood="SkelBlood", imageIndex=8, HP=2, speed=0.3, aitype=AI_MELEE, hasShield=false},
    skelpikeman = {name="Skeleton Pikeman", blood="SkelBlood", imageIndex=9, HP=2, speed=0.5, aitype=AI_MELEE, hasShield=false},
    skelknight = {name="Skeleton Knight", blood="SkelBlood", imageIndex=11, HP=3, speed=0.5, aitype=AI_MELEE, hasShield=true},
    darkknight = {name="Dark Knight", blood="BlackBlood", imageIndex=32, HP=10, speed=0.3, aitype=AI_MELEE, hasShield=true},
    darkmage = {name="Dark Mage", blood="BlackBlood", imageIndex=18, HP=2, speed=0.4, aitype=AI_MAGE, hasShield=false, spellID=0},
    icemage = {name="Ice Mage", imageIndex=19, HP=1, speed=0.4, aitype=AI_MAGE, hasShield=false, spellID=1},
    dwarf = {name="Dwarf", imageIndex=3, HP=1, speed=0.4, aitype=AI_MELEE, hasShield=false},
    dwarfguard = {name="Dwarf Guard", imageIndex=5, HP=10, speed=0.4, aitype=AI_MELEE, hasShield=true},
    dwarfcaptain = {name="Dwarf Captain", imageIndex=7, HP=10, speed=0.4, aitype=AI_MELEE, hasShield=true},
    dwarfknight = {name="Dwarf Knight", imageIndex=5, HP=6, speed=0.4, aitype=AI_MELEE, hasShield=true},
    dwarfmage = {name="Dwarf Mage", imageIndex=6, HP=4, speed=0.4, aitype=AI_MAGE, spellID=1, hasShield=false},
    dwarfking = {name="Dwarf King", imageIndex=4, HP=1, speed=0.2, aitype=AI_MELEE, hasShield=false},
    elfrogue = {name="Elf Rogue", imageIndex=63, HP=2, speed=0.6, aitype=AI_ARCHER, hasShield=false},
    dragonboss = {name="The Red Beast", blood="BlackBlood", imageIndex=666, HP=0, speed=0.4, aitype=AI_MAGE, spellID=0, hasShield=false},
    dummypost = {name="Dummy Post", blood="WoodBlood", imageIndex=62, HP=100000, speed=0, aitype=AI_MELEE, dummy=true, hasShield=false},
    halfimp = {name="Half Imp", blood="BlackBlood", imageIndex=24, HP=2, speed=0.6, aitype=AI_MELEE, hasShield=false},
    halfimpknight = {name="Half Imp Knight", blood="BlackBlood", imageIndex=25, HP=5, speed=0.4, aitype=AI_MELEE, hasShield=true},
    halfimparcher = {name="Half Imp Archer", blood="BlackBlood", imageIndex=26, HP=3, speed=0.3, aitype=AI_ARCHER, hasShield=false},
    imp = {name="Imp", blood="BlackBlood", imageIndex=27, HP=2, speed=0.6, aitype=AI_MELEE, hasShield=false},
    darkimp = {name="Dark Imp", blood="BlackBlood", imageIndex=28, HP=2, speed=0.6, aitype=AI_MAGE,spellID=0, hasShield=false},
    fireskull = {name="Fire Skull", blood="BlackBlood", imageIndex=23, HP=1, speed=0.8, aitype=AI_MELEE, hasShield=false},
}
